...
window.SOLANA_HISTORY_LANDMARKS = [
  ...
  },
  {
    ...
    category: "Outage", year: 2021, date: "2021-09", status: "verified", featured: true, danger: false,
    ...
    sources: [
      { label: "Solana: 9-14-2021 outage overview (official post-mortem)", url: "https://solana.com/news/9-14-network-outage-initial-overview" },
      { label: "Solana: 06-01-22 outage report (durable nonce, official)", url: "https://solana.com/news/06-01-22-solana-mainnet-beta-outage-report-2" },
      { label: "Solana: 09-30-22 outage report (official)", url: "https://solana.com/news/09-30-22-solana-mainnet-beta-outage-report" },
      { label: "Solana: 02-06-24 outage report (official)", url: "https://solana.com/news/02-06-24-solana-mainnet-beta-outage-report" },
      { label: "Solana status page — full incident history", url: "https://status.solana.com/history" },
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Jupiter v3: the Metis routing algo (official, Jul 2023)", url: "https://discuss.jup.ag/t/archived-jupiter-v3-the-metis-routing-algo/21712" },
      ...
      { label: "SolanaFloor — Jupiter aggregator market-share data (Dec 2025)", url: "https://solanafloor.com/news/jupiter-reclaims-dominance-with-93-6-market-share-in-solana-s-aggregator-landscape" }
    ]
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "CoinDesk — Pump.fun exploited by former employee (May 2024)", url: "https://www.coindesk.com/business/2024/05/16/solana-meme-coin-factory-pumpfun-compromised-by-bonding-curve-exploit" },
      { label: "FCA — warning notice on Pump.fun (official, Dec 2024)", url: "https://www.fca.org.uk/news/warnings/pumpfun" },
